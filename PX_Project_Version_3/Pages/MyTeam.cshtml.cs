        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (Team == null)
            {
                ...
                else
                {
                    ...
                    {
                        //That means the team leader hasn't upload the team presentation yet
                        TeamPresentationExists = false;
                    }
                    else
                    {
                        //Since the presentation for the team exists we are gonna allow the member to download the file
                        TeamPresentationExists = true;
                    }
                    return Page();
                }
            }
